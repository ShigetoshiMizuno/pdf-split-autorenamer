...
| バージョン | 状態 | 説明 |
|-----------|------|------|
| v0.1.0 | リリース済み | コア機能（analyze/split/rename/gui）、業務書類プロファイル |
| v0.2.0 | **実装済み（PR #10/#11/#12 マージ待ち）** | OCR レイヤーなし PDF 対応（Tesseract）、外部プロファイル読み込み、実行ファイル配布 |
| v0.3.0 | 計画中 | プラガブル OCR 設計、段階的 OCR パイプライン |
| v1.0.0 | **テスト 99%+（PR #12）、PyPI 承認待ち** | 安定リリース、テスト整備、PyPI 公開 |
